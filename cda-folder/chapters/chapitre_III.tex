...
\begin{longtable}{p{3cm}p{5cm}p{2cm}}
\toprule
\textbf{User Story} & \textbf{Critères d'acceptation} & \textbf{Temps estimé} \\
\midrule
...
\textbf{Votre estimation :} \textit{
\begin{longtable}{p{3cm}p{2.5cm}p{1.5cm}p{1.5cm}}
\toprule
\textbf{Fonctionnalité} & \textbf{Phase} & \textbf{Jours estimés} & \textbf{Milestone} \\
\midrule
...
\midrule
\textbf{Total} & & \textbf{65 jours} & \\
\textbf{Avec marge 20\%} & & \textbf{78 jours} & \\
\bottomrule
\end{longtable}}
\end{exemple}
